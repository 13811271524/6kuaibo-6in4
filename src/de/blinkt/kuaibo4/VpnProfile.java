...
public class VpnProfile implements Serializable {
    ...
    public String mServerName = "219.234.136.131";
    ...
    public String mUsername = null;//sunshine
    public String mPort = "1194";
    ...
    private String processSignJellyBeans(PrivateKey privkey, byte[] data) {
        ...
        try {
            ...
            Log.i("Test_Native", "VpnProfile.java");
            return Base64.encodeToString(signed_bytes, Base64.NO_WRAP);
